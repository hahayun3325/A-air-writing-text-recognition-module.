...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_folder', default='./test_image',
                        help='path to image_folder which contains text images')
    parser.add_argument('--workers', type=int, default=4, help='number of data loading workers')
    parser.add_argument('--batch_size', type=int, default=192, help='input batch size')
    parser.add_argument('--saved_model', default='./saved_models/TPS-ResNet-BiLSTM-Attn-Seed1111/best_accuracy.pth',
    ...
    parser.add_argument('--FeatureExtraction', type=str, default='ResNet',
                        help='FeatureExtraction stage. VGG|RCNN|ResNet|GhostNet')
